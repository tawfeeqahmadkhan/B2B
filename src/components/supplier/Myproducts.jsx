    ...
    return (
        ...
        <h1 className='font-bold'>Product Name</h1>
         ...
         <div className='flex flex-row gap-[50px]'>
            <button className='bg-indigo-500 text-white font-bold p-2 hover:bg-indigo-400'>Edit</button>
            <button className='bg-indigo-500 text-white font-bold p-2 hover:bg-indigo-400'>DELETE</button>
         </div>
        </div>
     </div>
